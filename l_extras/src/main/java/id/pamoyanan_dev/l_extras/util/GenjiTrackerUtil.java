...
public class GenjiTrackerUtil extends Service implements LocationListener {
    ...
    public GenjiTrackerUtil(Context context) {
    ...
    public void stopUsingGPS() {
        if (locationManager != null) {
            locationManager.removeUpdates(GenjiTrackerUtil.this);
        }
    }
